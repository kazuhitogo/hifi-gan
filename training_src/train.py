...
def train(rank, h):
    ...
    gpus = int(os.environ.get('SM_NUM_GPUS'))
...
def main():
    ...
    hps.setdefault('group_name', None)
    hps.setdefault('input_wavs_dir', os.path.join(os.environ.get('SM_CHANNEL_TRAINING'),'wavs'))
    ...
    hps.setdefault('checkpoint_interval', 5000)
